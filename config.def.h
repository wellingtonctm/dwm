...
static const Rule rules[] = {
	...
	{ "Brave-browser"  "teams.microsoft.com__v2",  NULL,  1 << 8,    0,          -1 },
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_y,                     spawn,             SHCMD("~/suckless/slscripts/plugins/dmenu/yt-cli.sh") },
	{ MODKEY|ShiftMask,             XK_b,                     spawn,             SHCMD("~/suckless/slscripts/plugins/dmenu/bluetooth.sh") },
	{ MODKEY,                       XK_v,                     spawn,             SHCMD("~/suckless/slscripts/plugins/dmenu/fortivpn.sh") },
	{ MODKEY,                       XK_w,                     spawn,             SHCMD("~/suckless/slscripts/plugins/dmenu/wifi.sh") },
	{ 0,                            XK_Print,                 spawn,             {.v = screenshotcmd } },
	{ 0,                            XF86XK_AudioRaiseVolume,  spawn,             SHCMD("~/suckless/slscripts/plugins/dwm/volume-plugin.o -i 5") },
	{ 0,                            XF86XK_AudioLowerVolume,  spawn,             SHCMD("~/suckless/slscripts/plugins/dwm/volume-plugin.o -d 5") },
	{ 0,                            XF86XK_AudioMute,         spawn,             SHCMD("~/suckless/slscripts/plugins/dwm/volume-plugin.o -t") },
	{ 0,                            XF86XK_AudioMicMute,      spawn,             SHCMD("~/suckless/slscripts/plugins/dwm/volume-plugin.o -m") },
